...
<head>
    ...
    <style>
        ...
        .card { background: #fff; border-radius: 18px; padding: 30px; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.06); border: 1px solid rgba(15, 61, 34, 0.12); }
        ...
        .step { font-size: 12px; font-weight: 700; color: #0f3d22; background: rgba(26, 107, 60, 0.08); border: 1px solid rgba(26, 107, 60, 0.18); padding: 6px 10px; border-radius: 999px; white-space: nowrap; }
        ...
        .btn-secondary { background: #fff; color: #0f3d22; border: 1.5px solid rgba(26, 107, 60, 0.35); }
        ...
        .pill { display: inline-flex; align-items: center; gap: 8px; font-size: 12px; font-weight: 700; padding: 8px 10px; border-radius: 999px; background: rgba(15, 61, 34, 0.06); border: 1px solid rgba(15, 61, 34, 0.14); color: #0f3d22; }
...
<div class="container">
    <div class="shell">
            ...
            <div class="header">
                <div class="brand">
                    <div class="brand-badge">
                        <img src="/logo-mark.png" alt="DestinyGate Institute" style="width:30px; height:30px; object-fit:contain;" />
                    </div>
                    <div>
        ...
        <div class="footer">
            ...
            <div style="margin-top:6px; font-size:11px; color:#94a3b8;">15412 Samson Kanyemba Street, Runyararo West, Masvingo &nbsp;·&nbsp; 0779 672 246 / 0710415364</div>
        </div>
    </div>
</div>
