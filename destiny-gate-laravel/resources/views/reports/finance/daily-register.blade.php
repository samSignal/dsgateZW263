...
<table class="report-table">
    <thead><tr><th>#</th><th>Receipt #</th><th>Student</th><th>Method</th><th>Received By</th><th class="text-right">Amount</th></tr></thead>
    <tbody>
    @php $n = 0; @endphp
    ...
    @endforeach
    @if(count($payments) === 0)
        <tr><td colspan="6" style="text-align:center; color:#9ca3af;">No payments recorded on this date.</td></tr>
    @endif
