...
<table class="report-table">
    <thead><tr><th>Receipt #</th><th>Student</th><th>Method</th><th>Date</th><th class="text-right">Amount</th></tr></thead>
    <tbody>
    ...
    @endforeach
    @if(count($payments) === 0)
        <tr><td colspan="5" style="text-align:center; color:#9ca3af;">No payments found.</td></tr>
    @endif
